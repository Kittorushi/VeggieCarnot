...
public abstract interface VeggieServices {
    ...
    kotlin.coroutines.Continuation<? super com.veggie.android.simpeldesa.api.models.veggie.VegiModel> p4);
    ...
    int paging, @retrofit2.http.Query(value = "limit")
    int limit, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super com.veggie.android.simpeldesa.api.models.veggie.VegiModel> p3);
